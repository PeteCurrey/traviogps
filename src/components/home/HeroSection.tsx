...
const serviceCards: ServiceCard[] = [
  {
    ...
    description: "Browse our curated collection of homes across the Peak District and beyond",
    href: "/sales",
  ...
  },
  {
    ...
    description: "Expert guidance for buyers and sellers in Derbyshire's most desirable areas",
    href: "/sell",
  ...
  },
  {
    ...
    description: "Get a free, no-obligation valuation from our experienced local team",
    href: "/valuation",
        ...
        <div className="relative flex items-start gap-5">
          ...
          <motion.div
            ...
            animate={{ 
              ...
              backgroundColor: isHovered ? "hsl(var(--accent) / 0.2)" : "hsl(var(--accent) / 0.1)"
            }}
          ...
          <div className="flex-1 min-w-0">
            ...
            <h3 className="font-serif text-xl lg:text-2xl text-foreground mt-1 mb-2">
              {card.title}
            </h3>
  ...
  return (
    <section ref={containerRef} className="relative min-h-screen bg-background pt-20 lg:pt-[104px]">
      ...
      <div className="h-[calc(100vh-80px)] lg:h-[calc(100vh-104px)] flex flex-col lg:flex-row">
        ...
        {/* Left side - Large featured image (60%) */}
        <motion.div
        ...
        >
          <motion.img
            src={heroBanner}
            alt="Beautiful Peak District property"
          ...
          {/* Hero text overlay - positioned bottom left */}
          <motion.div
          ...
          >
            <span className="text-xs uppercase tracking-[0.25em] text-primary/80 mb-3 block">
            ...
            <h1 className="font-serif text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-primary leading-[1.1] mb-4">
              ...
              <br />
              <span className="italic-accent">Across the Peak District</span>
            </h1>
            <p className="text-primary/70 text-sm md:text-base max-w-md hidden sm:block">
              Discover your dream home in Derbyshire's most desirable locations with expert guidance from our local team.
            </p>
          </motion.div>

          {/* Stats overlay - bottom right on larger screens */}
          <motion.div
        ...
        {/* Right side - Service cards stacked (40%) */}
        <div className="flex-1 lg:w-[40%] flex flex-col bg-background/95 backdrop-blur-sm">
          ...
          <motion.div
            ...
            className="px-6 lg:px-10 pt-6 lg:pt-10 pb-4"
          >
            ...
            <p className="text-sm text-muted-foreground mt-2">
              Expert property services tailored to your needs
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="px-6 lg:px-10 py-6 lg:py-8 border-t border-border/30"
          >
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="text-center sm:text-left">
                <p className="text-sm text-muted-foreground">Ready to take the next step?</p>
                <p className="text-xs text-muted-foreground/70 mt-1">
                  Call us on <a href="tel:+441246567540" className="text-accent hover:underline">01246 567 540</a>
                </p>
              </div>
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 px-6 py-3 bg-accent text-accent-foreground text-sm font-medium hover:bg-accent/90 transition-colors"
              >
                Contact Us
                <ArrowRight className="w-4 h-4" />
              </Link>
      ...
      >
        <span className="text-[10px] uppercase tracking-[0.25em] text-primary/60">
          Scroll
        </span>
        <motion.div
          animate={{ y: [0, 8, 0] }}
