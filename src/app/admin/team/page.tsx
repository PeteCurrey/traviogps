  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-serif text-2xl text-foreground font-serif">Team Members</h1>
          ...
          >
            <div className="aspect-[3/4] bg-secondary relative">
              {member.image ? (
                ...
                <div className="w-full h-full flex items-center justify-center text-4xl text-muted-foreground bg-secondary font-serif">
                  {member.full_name[0]}
                </div>
              )}
            </div>
      ...
      {members.length === 0 && (
        <div className="text-center py-12">
          ...
          <h3 className="font-serif text-lg text-foreground mb-2 font-serif">No team members yet</h3>
                    ...
                    {editingMember.image ? (
                      <div className="relative w-full h-full group">
                        ...
                        <button
                          ...
                          className="absolute top-1 right-1 p-1 bg-destructive rounded-full opacity-100 transition-opacity"
                        >
