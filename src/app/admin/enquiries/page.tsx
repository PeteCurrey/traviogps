...
export default function AdminEnquiriesPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="font-serif text-2xl text-foreground font-serif">Enquiries</h1>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <Select value={statusFilter} onValueChange={setStatusFilter}>
          <SelectTrigger className="w-[150px] bg-secondary border-border h-10">
              ...
              {filteredLeads.length === 0 ? (
                ...
                filteredLeads.map((lead, idx) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <span className={cn("text-xs px-2 py-1 rounded-full capitalize font-normal", statusColors[lead.status])}>
                        {lead.status}
                      </span>
                    </td>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <span className={cn("text-xs px-2 py-1 rounded-full capitalize font-normal", statusColors[selectedLead.status])}>
                    {selectedLead.status}
                  </span>
                </div>
                <div>
              ...
              {selectedLead.message && (
                <div>
                  ...
                  <p className="text-foreground bg-secondary p-3 rounded-sm text-sm">{selectedLead.message}</p>
                </div>
              )}
