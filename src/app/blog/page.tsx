        ...
        <div className="container-premium relative z-10">
          ...
          >
            ...
            <h1 className="font-serif text-display-3 md:text-display-2 lg:text-display-1 text-foreground mb-6">
              Tracking <span className="italic-accent">insights</span>
            </h1>
            <p className="text-lg text-muted-foreground max-w-2xl">
              Stay informed with the latest GPS tracking news, fleet management updates, 
              and expert advice from the Travio team.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          {isLoading ? (
              ...
              {posts.map((post) => (
                <motion.div key={post.id} variants={itemVariants}>
                  <Link href={`/blog/${post.slug}`} className="group block">
                    <Card className="h-full bg-card border-border overflow-hidden rounded-sm hover:border-accent/30 transition-all duration-300">
                      {post.featured_image && (
            ...
            >
              ...
              <p className="text-muted-foreground max-w-md mx-auto mb-8">
                We're working on some great content for you. Check back soon for GPS tracking 
                industry news, software insights, and helpful guides.
              </p>
        ...
        <div className="container-premium">
          ...
          >
            ...
            <p className="text-muted-foreground mb-8">
              Subscribe to our newsletter for the latest tracking news, platform updates, 
              and exclusive insights delivered straight to your inbox.
            </p>
            <Button asChild size="lg" className="bg-accent hover:bg-accent/90 text-accent-foreground border-none">
              <Link href="/contact">
                Subscribe Now
                <ArrowRight className="ml-2 h-4 w-4" />
              </Link>
