...
export default function StoreFront() {
  ...
  useJsonLd({
    ...
    url: typeof window !== "undefined" ? window.location.origin + "/products" : "https://travio.gps/products",
    potentialAction: {
      "@type": "SearchAction",
      target: (typeof window !== "undefined" ? window.location.origin : "https://travio.gps") + "/products/all?q={search_term_string}",
  ...
  useJsonLd({
    ...
    itemListElement: bestsellers.map((p, i) => ({
      ...
      item: {
        "@type": "Product",
        name: p.name,
        url: (typeof window !== "undefined" ? window.location.origin : "https://travio.gps") + `/products/${p.slug}`,
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Button asChild size="lg" className="btn-premium bg-accent hover:bg-accent/90 text-accent-foreground">
                <Link href="/products/all">Shop All Products <ArrowRight className="ml-2 h-4 w-4" /></Link>
              </Button>
              <Button asChild size="lg" variant="outline">
                <Link href="/products/compare">Compare Trackers</Link>
              </Button>
            </div>
          </motion.div>
        </div>
        ...
        <div className="container-premium">
          <div className="flex items-end justify-between mb-10">
            ...
            <Button asChild variant="outline" className="hidden md:flex">
              <Link href="/products/all">View All <ArrowRight className="ml-2 h-4 w-4" /></Link>
            </Button>
          </div>
          ...
          <div className="md:hidden text-center mt-8">
            <Button asChild variant="outline">
              <Link href="/products/all">View All Products <ArrowRight className="ml-2 h-4 w-4" /></Link>
            </Button>
          </div>
        </div>
      </section>
