      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          <div className="flex items-center justify-between p-4 border-b border-border">
            <h2 className="font-serif text-lg text-foreground">Recent Enquiries</h2>
            <Link to="/admin/enquiries" className="text-sm text-accent hover:text-accent/80 flex items-center gap-1">
        ...
        >
          <div className="flex items-center justify-between p-4 border-b border-border">
            ...
            <Link to="/admin/orders" className="text-sm text-accent hover:text-accent/80 flex items-center gap-1">
              View All <ArrowRight className="h-3 w-3" />
            </Link>
          </div>
          <div className="p-4">
